                ...
                <div class="card border-0 shadow-sm" style="border-radius: 6px;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="contact-item">
                            <div class="d-flex align-items-center">
                                <i class="fas fa-fax text-primary me-2" style="width: 16px; font-size: 0.9rem;"></i>
                                <div>
                                    <span class="fw-bold" style="font-size: 0.85rem;">Fax</span><br>
                                    <span class="text-muted" style="font-size: 0.8rem;">(0251) 123457</span>
                                </div>
                            </div>
                        </div>
                    </div>
